...
try:
    #rutas
    ruta_facturacion = r"C:\Users\COSTOS\Downloads\RELACION__DE_FACTURAS_POR_USUARIO_DETALLADO-20260624_023844.xlsx"
    ruta_consumos = r"C:\Users\COSTOS\Downloads\MOVIMIENTOS_INVENTARIO_DETALLADO_POR_ARTICULO-20260618_080915.xlsx"
    ruta_listado_productos = r"C:\Users\COSTOS\Downloads\LISTADO_INVENTARIO-20260618_082554.xlsx"

    #Lectura de archivos
    facturacion = pl.read_excel(ruta_facturacion, read_options={"header_row": 6})
    consumos = pl.read_excel(ruta_consumos, read_options={"header_row": 6})
    listado_productos = pl.read_excel(ruta_listado_productos, read_options={"header_row": 5})
